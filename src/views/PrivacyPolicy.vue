<template>
    ...
    <span style="color: rgb(127, 127, 127)">
      <strong>
        <span style="font-size: 15px">
          <span class="subtitle">Last updated <bdt class="question">September 17, 2023</bdt> </span>
        </span>
      </strong>
    </span>
  </div>
    ...
    <span style="color: rgb(127, 127, 127)">
      <span style="color: rgb(89, 89, 89); font-size: 15px">
        <span class="body_text"
          ...
          <bdt class="question">Charity Organisation <bdt class="block-component"></bdt> </bdt>
        ...
        <span class="body_text"
          ...
          <bdt class="else-block"></bdt>) your information when you use our services (
          <bdt class="block-component"></bdt>' <strong>Services</strong>'
          <bdt class="else-block"></bdt>), such as when you:
        </span>
      </span>
    </span>
    <span style="font-size: 15px">
      ...
      <span style="font-size: 15px; color: rgb(89, 89, 89)">
        <span style="font-size: 15px; color: rgb(89, 89, 89)">
          <span class="body_text"
            ...
            <bdt class="question">charity-org.onrender.com</bdt>
            <span style="font-size: 15px">
              <span style="color: rgb(89, 89, 89)">
                <span class="body_text">
                  <span style="font-size: 15px">
  ...
  <div>
      ...
      <span style="font-size: 15px">
        <span style="color: rgb(127, 127, 127)">
          <span class="body_text">
            ...
            please contact us at <bdt class="question">charity-org@gmail.com </bdt>.
          </span>
        </span>
      </span>
    </div>
    ...
    <div style="line-height: 1.5">
      <strong>
        <span style="font-size: 15px">
          <span class="heading_1">SUMMARY OF KEY POINTS</span>
        </span>
      </strong>
    </div>
    <div style="line-height: 1.5">
    ...
    <div style="line-height: 1.5">
      ...
      <a class="link" href="#personalinfo">
        <span style="font-size: 15px">
          <span class="body_text">personal information you disclose to us</span>
        </span>
      </a>
    ...
    <div style="line-height: 1.5">
      ...
      <a class="link" href="#infouse">
        <span style="font-size: 15px">
          <span class="body_text">how we process your information</span>
        </span>
      </a>
      <span class="body_text">.</span>
    </div>
    ...
    <div style="line-height: 1.5">
      ...
      <a class="link" href="#whoshare">
        <span style="font-size: 15px">
          <span class="body_text">when and with whom we share your personal information</span>
        </span>
      </a>
      <span style="font-size: 15px">
        <span class="body_text">. <bdt class="block-component"></bdt> </span>
      </span>
    </div>
    <div style="line-height: 1.5">
      <br />
    ...
    <div style="line-height: 1.5">
      ...
      <a class="link" href="#privacyrights">
        <span style="font-size: 15px">
          <span class="body_text">your privacy rights</span>
        </span>
      </a>
      <span class="body_text">.</span>
    </div>
    ...
    <div style="line-height: 1.5">
      <span style="font-size: 15px">
        <span class="body_text">
          ...
          <bdt class="question">isolezwe-classic.onrender.com</bdt> <bdt class="else-block"></bdt>,
    ...
    <div style="line-height: 1.5">
      ...
      <a class="link" href="#toc">
        <span style="font-size: 15px">
          <span class="body_text">Review the privacy notice in full</span>
        </span>
      </a>
      <span style="font-size: 15px">
        <span class="body_text">.</span>
      ...
      <span style="font-size: 15px">
        <span style="color: rgb(127, 127, 127)">
          <span style="color: rgb(0, 0, 0)">
            <strong>
              <span class="heading_1">TABLE OF CONTENTS</span>
            </strong>
          </span>
        </span>
      </span>
    ...
    <div style="line-height: 1.5">
      <span style="font-size: 15px">
        <a class="link" href="#infominors">
          <span style="color: rgb(89, 89, 89)">5. DO WE COLLECT INFORMATION FROM MINORS?</span>
        </a>
        <span style="color: rgb(127, 127, 127)">
          <span style="color: rgb(89, 89, 89)">
            <span class="body_text">
    ...
    <div style="line-height: 1.5">
      <span style="font-size: 15px">
        <span style="color: rgb(89, 89, 89)">
          <a class="link" href="#privacyrights">6. WHAT ARE YOUR PRIVACY RIGHTS?</a>
        </span>
      </span>
    </div>
    <div style="line-height: 1.5">
      <span style="font-size: 15px">
        <a class="link" href="#DNT">
          <span style="color: rgb(89, 89, 89)">7. CONTROLS FOR DO-NOT-TRACK FEATURES</span>
        </a>
      </span>
    </div>
    <div style="line-height: 1.5">
          ...
          <span style="font-size: 15px; color: rgb(89, 89, 89)">
            <span style="font-size: 15px; color: rgb(89, 89, 89)">
              <span id="control" style="color: rgb(0, 0, 0)">
                <strong>
                  <span class="heading_1">1. WHAT INFORMATION DO WE COLLECT?</span>
                </strong>
              </span>
            </span>
          </span>
        ...
        <span style="color: rgb(89, 89, 89); font-size: 15px">
          <span style="font-size: 15px; color: rgb(89, 89, 89)">
            <span style="font-size: 15px; color: rgb(89, 89, 89)">
              <span id="control" style="color: rgb(0, 0, 0)">
                <strong>
                  <span class="heading_1">2. HOW DO WE PROCESS YOUR INFORMATION?</span>
                </strong>
              </span>
            </span>
          </span>
                                                  ...
                                                  <div style="line-height: 1.5">
                                                    <span style="font-size: 15px">
                                                      <span class="body_text"
                                                        ...
                                                        need to share your personal information in
